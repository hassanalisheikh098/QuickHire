...
export default function Navbar({ activePage }) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border-dark bg-background-dark/80 backdrop-blur-md px-6 md:px-10 lg:px-20 py-4 flex items-center justify-between">
